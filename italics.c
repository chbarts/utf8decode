...
#define MAGICUC 120263
#define MAGICLC 120257
...
int main(int argc, char *argv[])
{
    ...
    if (!strcmp(argv[1], "--help") || !strcmp(argv[1], "-h")) {
        puts("italics [-u|--undo] [files...]");
        puts("Convert normal text to italics. With --undo, undoes this operation.");
        return 0;
    }

    if (!strcmp(argv[1], "--version") || !strcmp(argv[1], "-v")) {
        puts("italics version 1.0");
        return 0;
    }
